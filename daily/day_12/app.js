...
// Assignment: Part 0.63
// Credit: https://www.zybooks.com/
...
function cityInput(e) {
   ...
   console.log("Event: ", e ); // added Nov 13, 2025
   const city = document.getElementById(cityId).value.trim();
   console.log("cityID: ", cityId, "city: ", city ) // added Nov 13, 2025
...
function getWeatherForecast(city, cityId) {
   ...
   console.log( "XHRtype: ", xhr.responseType)
   // Send request
   xhr.open("GET", url);
   xhr.send();
}
